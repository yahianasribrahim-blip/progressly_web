...
export function CoverGrader() {
    ...
    const getScoreBg = (score: number) => {
        if (score >= 8) return "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300";
        if (score >= 6) return "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300";
        if (score >= 4) return "bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300";
