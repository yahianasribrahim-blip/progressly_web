...
import { useDeactivateAccountModal } from "@/components/modals/delete-account-modal";
import { Icons } from "@/components/shared/icons";

export function DeleteAccountSection() {
  const { setShowDeactivateAccountModal, DeactivateAccountModal } =
    useDeactivateAccountModal();
        ...
        <div className="flex flex-col gap-4 rounded-xl border border-red-400 p-4 dark:border-red-900">
          <div className="flex flex-col gap-2">
            ...
            <div className="text-balance text-sm text-muted-foreground">
              Your account will be deactivated for 7 days before permanent deletion.
              You can restore your account anytime within that period by logging in.
              {userPaidPlan ? " Your subscription will be paused during deactivation." : ""}
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Button
